...
export const PRODUCTS: Product[] = [
  {
    ...
    benefits: ["Enhanced root development", "Improved nutrient uptake", "Better soil health"], 
    ingredients: "Information coming soon", 
    applicationMethod: "Information coming soon",
    dosage: "Information coming soon", 
    packSizes: ["Information coming soon"],
    images: ["https://images.unsplash.com/photo-1592982537447-7440770cbfc9?w=800&auto=format&fit=crop&q=80"],
    documents: [], 
    suitableCrops: ["Rice", "Wheat", "Cotton", "Sugarcane", "Tomato", "Potato", "Onion", "Maize"], 
    targetProblems: ["Poor root growth", "Low nutrient uptake", "Soil deficiency"], 
    featured: true, 
    published: true,
  },
  {
    ...
    description: "Information coming soon - product details to be updated from official BioNature specifications.",
    benefits: ["Increased flowering", "Enhanced fruit development", "Better plant vigor"], 
    ingredients: "Information coming soon", 
    applicationMethod: "Information coming soon",
    dosage: "Information coming soon", 
    packSizes: ["Information coming soon"],
    ...
    documents: [], 
    suitableCrops: ["Tomato", "Chilli", "Brinjal", "Okra", "Cucumber", "Watermelon", "Mango", "Citrus"], 
    targetProblems: ["Poor flowering", "Low fruit set", "Weak plant growth"], 
    featured: true, 
    published: true,
  },
  {
    ...
    description: "Information coming soon - product details to be updated from official BioNature specifications.",
    benefits: ["Corrects magnesium deficiency", "Improves chlorophyll content", "Enhanced photosynthesis"], 
    ingredients: "Information coming soon", 
    applicationMethod: "Information coming soon",
    dosage: "Information coming soon", 
    packSizes: ["Information coming soon"],
    ...
    documents: [], 
    suitableCrops: ["Cotton", "Tomato", "Potato", "Grape", "Apple", "Banana", "Coconut", "Groundnut"], 
    targetProblems: ["Yellowing leaves", "Magnesium deficiency", "Poor chlorophyll"], 
    featured: false, 
    published: true,
  },
  {
    ...
    description: "Information coming soon - product details to be updated from official BioNature specifications.",
    benefits: ["Enhanced magnesium availability", "Better nutrient balance", "Improved crop quality"], 
    ingredients: "Information coming soon", 
    applicationMethod: "Information coming soon",
    dosage: "Information coming soon", 
    packSizes: ["Information coming soon"],
    images: ["https://images.unsplash.com/photo-1595974482597-4b8da8879bc5?w=800&auto=format&fit=crop&q=80"],
    documents: [], 
    suitableCrops: ["Sugarcane", "Rice", "Wheat", "Maize", "Soybean", "Sunflower", "Cotton", "Tea"], 
    targetProblems: ["Nutrient imbalance", "Soil magnesium deficiency", "Poor crop quality"], 
    featured: false, 
    published: true,
  },
  {
    ...
    description: "Information coming soon - product details to be updated from official BioNature specifications.",
    benefits: ["Soil enrichment", "Organic matter addition", "Sustainable nutrition"], 
    ingredients: "Information coming soon", 
    applicationMethod: "Information coming soon",
    dosage: "Information coming soon", 
    packSizes: ["Information coming soon"],
    images: ["https://images.unsplash.com/photo-1592982537447-7440770cbfc9?w=800&auto=format&fit=crop&q=80"],
    documents: [], 
    suitableCrops: ["Rice", "Wheat", "Maize", "Millets", "Sugarcane", "Cotton", "Pulses", "Vegetables"], 
    targetProblems: ["Poor soil fertility", "Low organic matter", "Nutrient deficiency"], 
    featured: true, 
    published: true,
  },
];
